...
<%def name="pretty_fraction(value, show_zero = True)">
%if value.denominator == 1:
...
%>
$\frac{${value.numerator}}{${value.denominator}} ${equals} ${text_value}$\
%endif
</%def>
...
\begin{tabular}{ll} 
	...
	{\textbf{Verhältnis}} & {${pretty_fraction(ratio)}}\\%
	{\textbf{Prozentual}} & {${f'{percent:.2f}'}}\%\\%
	{\textbf{Notenschema}} & 
